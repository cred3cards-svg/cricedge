...
exports.adminListTeams = (0, https_1.onCall)({ region: 'us-central1' }, async (req) => {
    try {
        if (!req.auth) {
        ...
        if (e instanceof https_1.HttpsError)
            throw e;
        throw new https_1.HttpsError('internal', e?.message ?? 'listTeams error');
    }
});
