...
exports.adminListTrades = void 0;
...
exports.adminListTrades = (0, https_1.onCall)({ region: 'us-central1' }, async (req) => {
    try {
        if (!req.auth) {
        ...
        if (e instanceof https_1.HttpsError)
            throw e;
        throw new https_1.HttpsError('internal', e?.message ?? 'adminListTrades error');
    }
});
//# sourceMappingURL=listTrades.js.map